...
export default function WelcomeScreen() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Track costs and automatically update requests as costs change. Perfect for utilities.",
    },
    {
        ...
        <div className="mb-12">
          ...
          <div className="flex gap-4 flex-wrap justify-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 border border-white hover:bg-gray-100/10 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200"
            >
