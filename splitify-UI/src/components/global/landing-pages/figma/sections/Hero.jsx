...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden">
      {/* Sticky viewport-filling backdrop */}
      <div className="pointer-events-none sticky top-0 h-[100dvh] -z-10">
        <section
          className={` 
        ...
        >
          ...
          `}
            ...
            reminders, and keeping bills updated as costs change.
              ...
              <p className="text-white ">
                Bills split, texts & emails sent, follow-ups handled, changing
                costs automtically kept updated.
              </p>
