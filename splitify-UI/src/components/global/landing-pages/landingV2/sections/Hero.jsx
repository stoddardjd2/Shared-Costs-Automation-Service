...
export default function Hero() {
  return (
    <section
      className="min-h-[100vh] pt-16 relative  overflow-hidden"
      style={
        // {
    ...
    >
      <div className="relative z-10">
        <div className="p-[clamp(1rem,5vw,2.5rem)]">
          {/* copy */}
          <div className="mt-[clamp(1rem,5vw,7rem)]">
            <p className="text-center mx-auto  px-[clamp(2rem,5vw,2rem)] py-2 mb-4 rounded-[60px] bg-white/100 text-gray-600 font-normal w-fit">
              *LIMITED TIME* New users now have access to premium features.
            </p>
            <h1 className="text-center mb-2">Split bills, not friendships.</h1>
            <p className="text-center text-gray-700">
              Splitify sends text messages for you until you get paid.
            </p>
        ...
        /> */}
          ...
          <div className="mt-10 constrained-width ">
            <div className="hidden md:inline  relative">
              <div className=" p-[clamp(0rem,1vw,1rem)] bg-gray-200/50  rounded-[clamp(0rem,2vw,1.5rem)] border border-gray-300">
                <img
                  src={dashboardImg}
                  alt="Dashboard demo"
            ...
            {/* MOBILE:"" */}
            <div className="flex flex-wrap justify-between md:hidden h-[clamp(250px,200px+7vw,250px)]">
              <img
                src={dashboardPhoneImg}
                alt="Dashboard demo"
                className="w-[350px] mx-auto rounded-[clamp(0rem,2vw,1.5rem)]"
              />
              {/* <img
                src={overdueTextPhoneImg}
                alt="overdue text demo"
        ...
        <div className="sticky bottom-0 bg-white py-6 shadow-sm border border-gray-200 mt-10">
          <div className="constrained-width  px-10">
            <PaymentLogos />
          </div>
        </div>
      </div>
