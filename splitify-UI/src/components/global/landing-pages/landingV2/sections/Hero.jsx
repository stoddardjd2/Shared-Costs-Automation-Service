  ...
  return (
    ...
    >
      <div className="relative z-10">
        <div className=" !pb-0 ">
          {/* copy */}
          <div className="p-[clamp(1rem,5vw,2.5rem)] pt-0 md:mt-[clamp(1rem,5vw,7rem)] sticky top-[90px] md:top-[190px] mb-10 ">
            <p className="text-center mx-4 md:mx-auto px-[clamp(2rem,5vw,2rem)] py-2 mb-4 rounded-[60px] bg-white/100 text-gray-600 font-normal w-fit">
