        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <br />
              <span style={{ color: 'rgb(37, 99, 235)' }}>That Actually Works</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Intelligent follow-ups and dynamic pricing eliminate payment delays while preserving professional relationships. 
              Get paid back 3x faster with zero manual intervention.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-blue-50 p-8 rounded-xl">
              <h3 className="font-bold text-lg text-gray-900 mb-4">Spltifiy Solution</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
