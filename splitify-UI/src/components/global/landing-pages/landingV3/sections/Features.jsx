...
const features = [
  ...
  },
  {
    ...
    description:"Missing payments? Splitify follows up with text messages until you get paid."
    ,
...

  {
    ...
    description: 
        'Splitify keeps a clear record of who’s paid. No stress, no confusion, and no disputes.'
    ,
    ...
    <section id="features" className="p-[clamp(1rem,5vw,2.5rem)]">
      <div className="constrained-width w-full">
        <FadeInWrapper>
          ...
          <h2 className="text-center">Features that make splitting easy</h2>
