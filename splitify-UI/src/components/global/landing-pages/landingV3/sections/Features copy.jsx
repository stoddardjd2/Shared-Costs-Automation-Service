...
const features = [
  ...
  },
  {
    ...
    title: <div>Automatic text reminders
</div>,
    description:
    ...
    <section id="features" className="p-[clamp(1rem,5vw,2.5rem)]">
      <div className="constrained-width w-full">
        <FadeInWrapper>
          ...
          <h2 className="text-center">Features that save time and relationships</h2>
...
function FeatureCard({
  ...
  return (
    <div>
      ...
      <div className="relative flex flex-col overflow-hidden w-full h-full bg-white border border-gray-200 rounded-2xl shadow-lg">
